    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Wheat", path: '/', icon: null },
                { text: "Rice", path: '/', icon: null },
                { text: "Maize", path: '/', icon: null },
                { text: "Barley", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Farm</span>2Market<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to Farm2Market, where farmers meet markets directly. We provide fair pricing, transparent trading, and smart insights to help farmers sell their produce with confidence.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © Farm2Market All Right Reserved.
                </p>
            </div>
        </footer>
    );
