...
export const categories = ["Rice", "Wheat", "Chana", "Lentils ", "Maize", "Barley","Groundnut","Mustard","SunFlower"];
...
export const ourSpecsData = [
    ...
    { title: "Secure Transactions", description: "Safe payments and verified buyers ensure a trusted trading experience.", icon: ClockFadingIcon, accent: '#FF8904' },
